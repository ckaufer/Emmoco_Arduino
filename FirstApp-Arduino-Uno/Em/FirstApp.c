...
const uint8_t Em_App_hash[] = {124, 222, 24, 201, 135, 244, 35, 197, 14, 170, 21, 17, 84, 224, 220, 189, 13, 0, ((sizeof(struct{uint8_t f1; uint16_t f2;}) - sizeof(uint16_t)) << 4) | (sizeof(struct{uint8_t f1; uint32_t f2;}) - sizeof(uint32_t))};

const uint8_t Em_App_build[] = {148, 253, 167, 42, 66, 1, 0, 0};

#define Em_App_APP_RESOURCE_COUNT 1
#define Em_App_SYS_RESOURCE_COUNT 9

#define Em_App_ACCEPT FirstApp_accept
#define Em_App_ACTIVATEPARAMETERS FirstApp_activateParameters
#define Em_App_BROADCASTOFF FirstApp_broadcastOff
...
#define Em_App_SETDEVICENAME FirstApp_setDeviceName
#define Em_App_START FirstApp_start
...
void Em_App_fetchDispatch(void) {
    ...
    switch (Em_App_msg.hdr.resId) {
        ...
        case 1: {
            ...
            Em_App_desc = "2";
            FirstApp_data_fetch(&val);
            Em_App_marshallToBuf();
#else
            FirstApp_data_fetch((void*)Em_App_msg.data);
#endif
            size = 2;
            break;
        }
...
void Em_App_storeDispatch(void) {
    switch (Em_App_msg.hdr.resId) {
        ...
        case 1: {
            ...
            FirstApp_data_store(&val);
#else
            FirstApp_data_store((void*)Em_App_msg.data);
#endif
            break;
        }
    }
